...
CREATE TABLE ESCOLA(
	...
	CONSTRAINT FK_ESCOLA_DIC_ESCOLA FOREIGN KEY(TIPO_ADM_ESCOLA) REFERENCES DIC_ESCOLA(ID_DIC),
	CONSTRAINT FK_ESCOLA_DIC_ESCO_LA FOREIGN KEY(TIPO_LOCALIZACAO) REFERENCES DIC_ESCOLA(ID_DIC),
	CONSTRAINT FK_ESCOLA_DIC_ESCOL_A FOREIGN KEY(SIT_FUNC_ESCOLAR) REFERENCES DIC_ESCOLA(ID_DIC)
);
...
CREATE TABLE DIC_NECESSIDADES_ESPECIAIS(
	ID_DIC NUMERIC  NOT NULL PRIMARY KEY,
	DIC_TPM_ADM_ESCOLA VARCHAR(4) NULL
);